...
rmarkdown::render(input = "rmarkdown/SMT-Dental-Report-Slides.Rmd",
                  ...
                  output_file = paste0("../reports/national_pack_Dec/SMT data pres December ","National ", Sys.Date()," v1.pdf"))
...
for(r in regions){
  rmarkdown::render(input = "rmarkdown/SMT-Dental-Report-Slides.Rmd",
                    ...
                    output_file = paste0("../reports/regional_packs_Dec/SMT data pres December ",r, " ",Sys.Date()," v1.pdf"))
}
...
for(s in STPs){
  rmarkdown::render(input = "rmarkdown/SMT-Dental-Report-Slides.Rmd",
                    ...
                    output_file = paste0("../reports/STP_packs_Dec/SMT data pres December ",s, " ",Sys.Date()," v1.pdf"))
}