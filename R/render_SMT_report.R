...
rmarkdown::render(input = "rmarkdown/SMT-Dental-Report-Slides.Rmd",
                  ...
                  output_file = paste0("../reports/national_pack_Jan/SMT data pres January ","National ", Sys.Date()," v1.pdf"))
...
for(r in regions){
  rmarkdown::render(input = "rmarkdown/SMT-Dental-Report-Slides.Rmd",
                    ...
                    output_file = paste0("../reports/regional_packs_Jan/SMT data pres January ",r, " ",Sys.Date()," v1.pdf"))
}
...
for(s in STPs){
  rmarkdown::render(input = "rmarkdown/SMT-Dental-Report-Slides.Rmd",
                    ...
                    output_file = paste0("../reports/STP_packs_Jan/SMT data pres January ",s, " ",Sys.Date()," v1.pdf"))
}