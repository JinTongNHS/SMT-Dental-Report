...
# 
# library(readxl)
# UDA_scheduled_Jun23 <- read_excel("N:/_Everyone/Primary Care Group/SMT_Dental DENT 2022_23-008/raw_eDEN_dental_data/UDA_scheduled_raw_data/UDA_scheduled_Jun23.xlsx", 
#                                   skip = 3)
# View(UDA_scheduled_Jun23)


import_and_clean_scheduled_UDA_data <- function(data_path_="N:/_Everyone/Primary Care Group/SMT_Dental DENT 2022_23-008/raw_eDEN_dental_data/UDA_scheduled_raw_data/",
  ...
  data_path <- paste0(data_path_, "UDA_scheduled_", data_month_name,".xlsx")
...
#function to import and clean data
#N.B. this assumes that the columns are in the same order each time!
import_and_clean_scheduled_UOA_data <- function(data_path_= "N:/_Everyone/Primary Care Group/SMT_Dental DENT 2022_23-008/raw_eDEN_dental_data/UOA_scheduled_raw_data/",
                                                data_date=data_month,
                                                commissioner_lookup = STP_ICB_lookup_codes){
  
  data_month_name <- format(Sys.Date()  - lubridate::duration("1 week"), format = "%b%y")
  
  data_path <- paste0(data_path_, "UOA_scheduled_", data_month_name,".xlsx")
...
UDA_calendar_Apr_Jun23 <- read_excel("N:/_Everyone/Primary Care Group/SMT_Dental DENT 2022_23-008/raw_eDEN_dental_data/UDA_calendar_raw_data/UDA_calendar_Apr_Jun23.xlsx", 
                                     skip = 5)
