...
plot_cumulative_UDA_UOA_to_target <- function(data = UDA_calendar_data, 
  ...
  if(UDAorUOA == "UDA"){
    ...
    data <- get_data_for_cumulative_plot(data, remove_prototypes = T)
    ...
    data <- get_data_for_cumulative_plot_UOA(data, remove_prototypes = T)
...
plot_UDA_UOA_delivery_profile <- function(data = UDA_scheduled_data, 
  ...
  #get data into the right format
  data <- get_delivery_profile_data(data = data, UDAorUOA = UDAorUOA, remove_prototypes = T)
