...
<!-- ```{r echo = FALSE, warning = FALSE, fig.height=4} -->
<!-- plot_UDA_UOA_to_target(get_into_slide4_format_calendar(dental_data_combined_calendar, remove_prototypes = T), "UDA") -->
<!-- ``` -->
...
<!-- ```{r echo = FALSE, warning = FALSE, fig.height=4} -->
<!-- plot_cumulative_UDA_UOA_to_target(get_into_slide4_format_calendar(dental_data_combined_calendar, remove_prototypes = T), "UDA") -->
<!-- ``` -->
...
```
<!-- get_slide4_table(remove_prototypes = F) -->
...
<!-- plot_cumulative_UDA_UOA_to_target(data = get_into_slide6_format_calendar(remove_prototypes = F), "UOA") -->
