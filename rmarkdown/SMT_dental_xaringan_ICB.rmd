...
STP_ICB_lookup <- read_excel("../data/STP_ICB_lookup.xlsx")
UDA_scheduled_data <- correct_STP_ICBs(UDA_scheduled_data)
UDA_calendar_data <- correct_STP_ICBs(UDA_calendar_data)
UOA_scheduled_data <- correct_STP_ICBs(UOA_scheduled_data)
UOA_calendar_data <- correct_STP_ICBs(UOA_calendar_data)
 ...
 * [Banded courses of treatment time series as % of April 2019 delivery](#banded-cots-index)
