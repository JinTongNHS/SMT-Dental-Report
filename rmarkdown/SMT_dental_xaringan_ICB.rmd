...
#historical_UDA_scheduled_data <- readRDS("../data/all_UDA_scheduled_historical_data.rds")
...
#Read local 111 file
dental_data_111 <- read_excel("N:/_Everyone/Primary Care Group/SMT_Dental/111_pathways_data/dental_data_111.xlsx")
...
#read in recalls 
dental_recalls_STP_2018_22 <- readRDS("../data/recalls/dental_recalls_STP_2018_22.rds")

#read in CDS data
#CDS_data <- read_excel("../data/CDS/CDS_Data_for_r.xlsx")
CDS_data <- read_excel("../data/CDS/CDS_Data_July22.xlsx")

#read in hand backs data
contract_handbacks <- read_excel("../data/contract_handbacks.xlsx")

#read in and clean complaints data
Dental_Access_Complaints_Data_June_22 <- read_excel("../data/complaints/Dental Access Complaints Data June 22.xlsx")
dental_complaints <- clean_complaints_data(Dental_Access_Complaints_Data_June_22)

#UDA value data
UDA_values <- read_excel("../data/UDA_values.xlsx")
