...
* This graph shows the average monthly performance of the **`r get_num_contracts(level = params$level, region_STP_name = params$region_STP_name)`** GDS/PDS/PDS+ contracts measured against the expected monthly 
delivery required to reach the quarterly thresholds (65% for Oct-Dec).
* In **`r format(Sys.Date() - lubridate::weeks(4), "%B")`**, **20.8%** of the total contracted UDAs for Q3 were delivered. This was **below** the 21.7% delivery required to be on track to meet the 65% threshold by the end of December.”
...
GDS/PDS contracts measured against the expected monthly 
delivery required to reach the the quarterly thresholds (85% for Oct-Dec).
* In **`r format(Sys.Date() - lubridate::weeks(4), "%B")`**, **23.6%** of the total contracted UOAs for Q3 were delivered. This was **below** the 28.3% delivery required to be on track to meet the 85% threshold by the end of December.”
* N.B. Previous month's delivery may be marginally different to what was reported last month 
due to the nature of calendar data (see slide 3).
