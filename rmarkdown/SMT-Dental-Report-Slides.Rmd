...
author: |
  ![](footer.jpg){width=12cm} 
date:  "`r format(Sys.time(), '%d %B, %Y')`"
output:
  beamer_presentation:
    includes:
      in_header: slide_format.tex
...
* This graph shows the average monthly performance of the *6,851* GDS/PDS/PDS+ contracts 
...
* This graph shows the cumulative (Year-to-date) activity of the *6,867* GDS/PDS/PDS+ 
...
* From *April to  August* *4,297* contracts (out of *6,867* - *63%*) have delivered 
the required UDAs or more towards the H1 2021/22 activity threshold by September.
...
## UDA delivery profile July-20 to July-21
...
threshold.
* From *April to August* *359* contracts (*47*%) have delivered 
...
## UOA delivery profile July-20 to July-21
