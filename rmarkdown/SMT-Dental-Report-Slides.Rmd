...
* From April to `r format(Sys.Date() - lubridate::month(1), "%B")` **`r get_num_contracts_on_target(level = params$level, region_STP_name = params$region_STP_name)`** 
contracts (**`r round(get_num_contracts_on_target(level = params$level, region_STP_name = params$region_STP_name)*100/get_num_contracts(level = params$level, region_STP_name = params$region_STP_name))`%**) 
