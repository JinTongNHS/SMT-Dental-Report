...
* From the start of April to the end of `r format(Sys.Date() - lubridate::month(1), "%B")`  **`r get_Q4_num_contracts_on_target(level = params$level, region_STP_name = params$region_STP_name)`**
