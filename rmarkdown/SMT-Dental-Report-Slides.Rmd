...
#load in raw data
UDA_calendar_data <- read_excel("../data/cleaned_data_up_to_december/UDA_calendar_data.xlsx")
UOA_calendar_data <- read_excel("../data/cleaned_data_up_to_december/UOA_calendar_data.xlsx")
UDA_scheduled_data <- read_excel("../data/cleaned_data_up_to_december/UDA_scheduled_data.xlsx")
UOA_scheduled_data <- read_excel("../data/cleaned_data_up_to_december/UOA_scheduled_data.xlsx")
...
dental_data_111 <- read_excel("../data/cleaned_data_up_to_november/111_dental_data.xls", 
...
* The number of contracts delivering above 65% contracted value for this month is **`r plot_delivery_vs_contract_size_scatter_corporate(level = params$level, region_STP_name = params$region_STP_name, get_num_above = 0.65)[1]`**
(out of **`r get_num_contracts(level = params$level, region_STP_name = params$region_STP_name)`** contracts),
with a mean contract size of **`r plot_delivery_vs_contract_size_scatter_corporate(level = params$level, region_STP_name = params$region_STP_name, get_num_above = 0.65)[2]`** UDAs.
