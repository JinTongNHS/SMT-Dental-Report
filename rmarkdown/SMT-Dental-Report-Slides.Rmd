...
#load in raw data
UDA_calendar_data <- read_excel("../data/cleaned_data_up_to_january/UDA_calendar_data.xlsx")
UOA_calendar_data <- read_excel("../data/cleaned_data_up_to_january/UOA_calendar_data.xlsx")
UDA_scheduled_data <- read_excel("../data/cleaned_data_up_to_january/UDA_scheduled_data.xlsx")
UOA_scheduled_data <- read_excel("../data/cleaned_data_up_to_january/UOA_scheduled_data.xlsx")
...
dental_data_111 <- readRDS("../data/cleaned_data_up_to_january/dental_data_111.rds")
...
* From October to `r format(Sys.Date() - lubridate::month(1), "%B")` **`r get_Q4_num_contracts_on_target(level = params$level, region_STP_name = params$region_STP_name)`**
