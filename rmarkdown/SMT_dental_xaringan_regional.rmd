...
* This graph shows the average monthly performance of the **`r get_num_contracts(level = "National", region_STP_name = NULL)`** GDS/PDS/PDS+ contracts scaled up by 12 months measured against the delivery thresholds (65% for Oct-Dec, 60% for Apr-Sep).
...
* This graph shows the average monthly performance of the **`r get_num_contracts(level = "Regional", region_STP_name = "South East")`** GDS/PDS/PDS+ contracts scaled up by 12 months measured against the delivery thresholds (65% for Oct-Dec, 60% for Apr-Sep).
* N.B. Previous month's delivery may be marginally higher to what was reported last month
due to the nature of calendar data (see slide 3). This month's figure is likely to be under-reported. 
...
* This graph shows the average monthly performance of the **`r get_num_contracts(level = "Regional", region_STP_name = "South West")`** GDS/PDS/PDS+ contracts scaled up by 12 months measured against the delivery thresholds (65% for Oct-Dec, 60% for Apr-Sep).
* N.B. Previous month's delivery may be marginally higher to what was reported last month
due to the nature of calendar data (see slide 3). This month's figure is likely to be under-reported. 
...
* This graph shows the average monthly performance of the **`r get_num_contracts(level = "Regional", region_STP_name = "North West")`** GDS/PDS/PDS+ contracts scaled up by 12 months measured against the delivery thresholds (65% for Oct-Dec, 60% for Apr-Sep).
* N.B. Previous month's delivery may be marginally higher to what was reported last month
due to the nature of calendar data (see slide 3). This month's figure is likely to be under-reported. 
...
* This graph shows the average monthly performance of the **`r get_num_contracts(level = "Regional", region_STP_name = "North East and Yorkshire")`** GDS/PDS/PDS+ contracts scaled up by 12 months measured against the delivery thresholds (65% for Oct-Dec, 60% for Apr-Sep).
* N.B. Previous month's delivery may be marginally higher to what was reported last month
due to the nature of calendar data (see slide 3). This month's figure is likely to be under-reported. 
...
* This graph shows the average monthly performance of the **`r get_num_contracts(level = "Regional", region_STP_name = "London")`** GDS/PDS/PDS+ contracts scaled up by 12 months measured against the delivery thresholds (65% for Oct-Dec, 60% for Apr-Sep).
* N.B. Previous month's delivery may be marginally higher to what was reported last month
due to the nature of calendar data (see slide 3). This month's figure is likely to be under-reported. 
...
* This graph shows the average monthly performance of the **`r get_num_contracts(level = "Regional", region_STP_name = "Midlands")`** GDS/PDS/PDS+ contracts scaled up by 12 months measured against the delivery thresholds (65% for Oct-Dec, 60% for Apr-Sep).
* N.B. Previous month's delivery may be marginally higher to what was reported last month
due to the nature of calendar data (see slide 3). This month's figure is likely to be under-reported. 
...
* This graph shows the average monthly performance of the **`r get_num_contracts(level = "Regional", region_STP_name = "East of England")`** GDS/PDS/PDS+ contracts scaled up by 12 months measured against the delivery thresholds (65% for Oct-Dec, 60% for Apr-Sep).
* N.B. Previous month's delivery may be marginally higher to what was reported last month
due to the nature of calendar data (see slide 3). This month's figure is likely to be under-reported. 
...
* From January to `r format(Sys.Date() - lubridate::month(1), "%B")` 
...
* The number of contracts delivering above 85% contracted value for this month is 
**`r plot_delivery_vs_contract_size_scatter_corporate(level = "National", region_STP_name = NULL, get_num_above = 0.85)[1]`**
(out of **`r get_num_contracts(level = "National", region_STP_name = NULL)`** contracts),
with a mean contract size of 
**`r plot_delivery_vs_contract_size_scatter_corporate(level = "National", region_STP_name = NULL, get_num_above = 0.85)[2]`** 
UDAs.
...
* The scatter plot shows the relationship between contract size and delivery for the current month.
* The number of contracts delivering above 85% contracted value for this month is 
**`r plot_delivery_vs_contract_size_scatter_corporate(level = "Regional", region_STP_name = "South East", get_num_above = 0.85)[1]`**
(out of **`r get_num_contracts(level = "Regional", region_STP_name = "South East")`** contracts),
with a mean contract size of 
**`r plot_delivery_vs_contract_size_scatter_corporate(level = "Regional", region_STP_name = "South East", get_num_above = 0.85)[2]`** 
UDAs.
* The number of contracts delivering above 100% contracted value for this month is 
...
* The scatter plot shows the relationship between contract size and delivery for the current month.
* The number of contracts delivering above 85% contracted value for this month is 
**`r plot_delivery_vs_contract_size_scatter_corporate(level = "Regional", region_STP_name = "South West", get_num_above = 0.85)[1]`**
(out of **`r get_num_contracts(level = "Regional", region_STP_name = "South West")`** contracts),
with a mean contract size of 
**`r plot_delivery_vs_contract_size_scatter_corporate(level = "Regional", region_STP_name = "South West", get_num_above = 0.85)[2]`** 
UDAs.
* The number of contracts delivering above 100% contracted value for this month is 
...
* The scatter plot shows the relationship between contract size and delivery for the current month.
* The number of contracts delivering above 85% contracted value for this month is 
**`r plot_delivery_vs_contract_size_scatter_corporate(level = "Regional", region_STP_name = "North West", get_num_above = 0.85)[1]`**
(out of **`r get_num_contracts(level = "Regional", region_STP_name = "North West")`** contracts),
with a mean contract size of 
**`r plot_delivery_vs_contract_size_scatter_corporate(level = "Regional", region_STP_name = "North West", get_num_above = 0.85)[2]`** 
UDAs.
* The number of contracts delivering above 100% contracted value for this month is 
...
* The scatter plot shows the relationship between contract size and delivery for the current month.
* The number of contracts delivering above 85% contracted value for this month is 
**`r plot_delivery_vs_contract_size_scatter_corporate(level = "Regional", region_STP_name = "North East and Yorkshire", get_num_above = 0.85)[1]`**
(out of **`r get_num_contracts(level = "Regional", region_STP_name = "North East and Yorkshire")`** contracts),
with a mean contract size of 
**`r plot_delivery_vs_contract_size_scatter_corporate(level = "Regional", region_STP_name = "North East and Yorkshire", get_num_above = 0.85)[2]`** 
UDAs.
* The number of contracts delivering above 100% contracted value for this month is 
...
* The scatter plot shows the relationship between contract size and delivery for the current month.
* The number of contracts delivering above 85% contracted value for this month is 
**`r plot_delivery_vs_contract_size_scatter_corporate(level = "Regional", region_STP_name = "London", get_num_above = 0.85)[1]`**
(out of **`r get_num_contracts(level = "Regional", region_STP_name = "London")`** contracts),
with a mean contract size of 
**`r plot_delivery_vs_contract_size_scatter_corporate(level = "Regional", region_STP_name = "London", get_num_above = 0.85)[2]`** 
UDAs.
* The number of contracts delivering above 100% contracted value for this month is 
...
* The scatter plot shows the relationship between contract size and delivery for the current month.
* The number of contracts delivering above 85% contracted value for this month is 
**`r plot_delivery_vs_contract_size_scatter_corporate(level = "Regional", region_STP_name = "Midlands", get_num_above = 0.85)[1]`**
(out of **`r get_num_contracts(level = "Regional", region_STP_name = "Midlands")`** contracts),
with a mean contract size of 
**`r plot_delivery_vs_contract_size_scatter_corporate(level = "Regional", region_STP_name = "Midlands", get_num_above = 0.85)[2]`** 
UDAs.
* The number of contracts delivering above 100% contracted value for this month is 
...
* The scatter plot shows the relationship between contract size and delivery for the current month.
* The number of contracts delivering above 85% contracted value for this month is 
**`r plot_delivery_vs_contract_size_scatter_corporate(level = "Regional", region_STP_name = "East of England", get_num_above = 0.85)[1]`**
(out of **`r get_num_contracts(level = "Regional", region_STP_name = "East of England")`** contracts),
with a mean contract size of 
**`r plot_delivery_vs_contract_size_scatter_corporate(level = "Regional", region_STP_name = "East of England", get_num_above = 0.85)[2]`** 
UDAs.
* The number of contracts delivering above 100% contracted value for this month is 
...
) have delivered the required UOAs or more to be on track towards the Q4 threshold (90%) by the end of March 2022.
