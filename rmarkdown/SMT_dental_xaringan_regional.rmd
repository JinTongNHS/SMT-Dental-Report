 ...
 * [111 call volumes by disposition](#111-breakdown)
...
<!-- DT::datatable(plot_banded_CoT(data = UDA_scheduled_data, -->
<!--                 calendar_data = UDA_calendar_data, -->
<!--                 historic_data = historical_UDA_scheduled_data, -->
<!--                 level = "National", -->
<!--                 region_STP_name = NULL, -->
<!--                 plotChart = F), -->
<!--               rownames=FALSE,  extensions = 'Buttons', options = list(dom='Bt', buttons = c('excel'), -->
<!--   bPaginate = FALSE, pageLength=35, columnDefs = list(list(className = 'dt-left', targets = 0:2)),searching=FALSE,scrollY ='350px', scrollX ='500px'))%>% -->
...
<!-- DT::datatable(plot_urgent_form_submissions(data = UDA_scheduled_data, -->
<!--                 calendar_data = UDA_calendar_data, -->
<!--                 historic_data = historical_UDA_scheduled_data, -->
<!--                 level = "National", -->
<!--                 region_STP_name = NULL, -->
...
<!-- ```{r xaringan-panelset-111_volumes, echo=FALSE} -->
<!-- xaringanExtra::use_panelset() -->
<!-- ``` -->
<!--  <font size="2"> -->
<!-- .panelset[ -->
...
<!--  .panel[.panel-name[National] -->
<!-- ```{r echo = FALSE, warning = FALSE, message = FALSE, fig.width=14, fig.height=5, eval=evaluate_111} -->
<!-- plot_111_referrals() -->
<!-- ``` -->
...
<!-- DT::datatable(plot_breakdown_111_referrals(plotChart = F), -->
<!--               rownames=FALSE,  extensions = 'Buttons', options = list(dom='Bt', buttons = c('excel'), -->
<!--   bPaginate = FALSE, pageLength=35, columnDefs = list(list(className = 'dt-left', targets = 0:4)),searching=FALSE,scrollY ='350px', scrollX ='500px'))%>% -->
<!--   DT::formatStyle(columns = c(1, 2, 3, 4, 5), fontSize = '90%') -->
<!-- ``` -->
...
<!-- DT::datatable(plot_unique_patients_rolling(data = unique_patients_rolling, -->
<!--                                      calendar_data = UDA_calendar_data, -->
<!--                                      scheduled_data = UDA_scheduled_data, -->
<!--                                      level = "National", -->
<!--                                      region_STP_name = NULL, -->
