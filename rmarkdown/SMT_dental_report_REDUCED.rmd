...
contracts (
**`r round(get_Q1_22_num_contracts_on_target(UOA_scheduled_data, remove_prototypes = T, UDAorUOA = "UOA", level = "National", region_STP_name = NULL)*100/get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UDAorUOA = "UOA", level = "National", region_STP_name = NULL))` %**
