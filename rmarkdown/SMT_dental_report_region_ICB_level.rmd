...
#source in all files from format data folder
...
contractor_categories <- readRDS("N:/_Everyone/Primary Care Group/SMT_Dental DENT 2022_23-008/data_for_monthly_report/contractor_categories.RDS")
 ...
 * [Calendar UDA activity](#calendar-uda-activity)
 * [Calendar UDA activity by MY category](#calendar-uda-activity-my-cat)
 * [Cumulative UDA delivery per quarter](#cumulative-udas)
 * [Scheduled UDAs](#scheduled-udas)
...
#### Orthodontic 
 * [Calendar UOA activity](#calendar-uoa-activity)
 * [Calendar UOA activity by MY category](#calendar-uoa-activity-my-cat)
 * [Cumulative UOA delivery per quarter](#cumulative-uoas)
 * [Scheduled UOAs](#scheduled-uoas)
...
name: calendar-uda-activity-my-cat
...
**`r get_Q1_22_num_contracts_on_target(level = "Regional", region_STP_name = region)`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(level = "Regional", region_STP_name = region)*100/get_num_contracts(level = "Regional", region_STP_name = region))` %**
...
contracts measured against the expected monthly total activity to achieve the quarterly thresholds (95% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(level = "STP", region_STP_name = STP1)`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(level = "STP", region_STP_name = STP1)*100/get_num_contracts(level = "STP", region_STP_name = STP1))` %**
) have delivered the required UDAs or more to be on track towards the Q1 threshold (95%) by the end of June 2022.
...
contracts measured against the expected monthly total activity to achieve the quarterly thresholds (95% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(level = "STP", region_STP_name = STP2)`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(level = "STP", region_STP_name = STP2)*100/get_num_contracts(level = "STP", region_STP_name = STP2))` %**
) have delivered the required UDAs or more to be on track towards the Q1 threshold (95%) by the end of June 2022.
...
contracts measured against the expected monthly total activity to achieve the quarterly thresholds (95% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(level = "STP", region_STP_name = STP3)`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(level = "STP", region_STP_name = STP3)*100/get_num_contracts(level = "STP", region_STP_name = STP3))` %**
) have delivered the required UDAs or more to be on track towards the Q1 threshold (95%) by the end of June 2022.
...
contracts measured against the expected monthly total activity to achieve the quarterly thresholds (95% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r if(eval4){get_Q1_22_num_contracts_on_target(level = "STP", region_STP_name = STP4)}`**
contracts (
**`r if(eval4){round(get_Q1_22_num_contracts_on_target(level = "STP", region_STP_name = STP4)*100/get_num_contracts(level = "STP", region_STP_name = STP4))}` %**
) have delivered the required UDAs or more to be on track towards the Q1 threshold (95%) by the end of June 2022.
...
contracts measured against the expected monthly total activity to achieve the quarterly thresholds (95% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r if(eval5){get_Q1_22_num_contracts_on_target(level = "STP", region_STP_name = STP5)}`**
contracts (
**`r if(eval5){round(get_Q1_22_num_contracts_on_target(level = "STP", region_STP_name = STP5)*100/get_num_contracts(level = "STP", region_STP_name = STP5))}` %**
) have delivered the required UDAs or more to be on track towards the Q1 threshold (95%) by the end of June 2022.
...
contracts measured against the expected monthly total activity to achieve the quarterly thresholds (95% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r if(eval6){get_Q1_22_num_contracts_on_target(level = "STP", region_STP_name = STP6)}`**
contracts (
**`r if(eval6){round(get_Q1_22_num_contracts_on_target(level = "STP", region_STP_name = STP6)*100/get_num_contracts(level = "STP", region_STP_name = STP6))}` %**
) have delivered the required UDAs or more to be on track towards the Q1 threshold (95%) by the end of June 2022.
...
contracts measured against the expected monthly total activity to achieve the quarterly thresholds (95% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r if(eval7){get_Q1_22_num_contracts_on_target(level = "STP", region_STP_name = STP7)}`**
contracts (
**`r if(eval7){round(get_Q1_22_num_contracts_on_target(level = "STP", region_STP_name = STP7)*100/get_num_contracts(level = "STP", region_STP_name = STP7))}` %**
) have delivered the required UDAs or more to be on track towards the Q1 threshold (95%) by the end of June 2022.
...
contracts measured against the expected monthly total activity to achieve the quarterly thresholds (95% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r if(eval8){get_Q1_22_num_contracts_on_target(level = "STP", region_STP_name = STP8)}`**
contracts (
**`r if(eval8){round(get_Q1_22_num_contracts_on_target(level = "STP", region_STP_name = STP8)*100/get_num_contracts(level = "STP", region_STP_name = STP8))}` %**
) have delivered the required UDAs or more to be on track towards the Q1 threshold (95%) by the end of June 2022.
...
contracts measured against the expected monthly total activity to achieve the quarterly thresholds (95% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r if(eval9){get_Q1_22_num_contracts_on_target(level = "STP", region_STP_name = STP9)}`**
contracts (
**`r if(eval9){round(get_Q1_22_num_contracts_on_target(level = "STP", region_STP_name = STP9)*100/get_num_contracts(level = "STP", region_STP_name = STP9))}` %**
) have delivered the required UDAs or more to be on track towards the Q1 threshold (95%) by the end of June 2022.
...
contracts measured against the expected monthly total activity to achieve the quarterly thresholds (95% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r if(eval10){get_Q1_22_num_contracts_on_target(level = "STP", region_STP_name = STP10)}`**
contracts (
**`r if(eval10){round(get_Q1_22_num_contracts_on_target(level = "STP", region_STP_name = STP10)*100/get_num_contracts(level = "STP", region_STP_name = STP10))}` %**
) have delivered the required UDAs or more to be on track towards the Q1 threshold (95%) by the end of June 2022.
...
contracts measured against the expected monthly total activity to achieve the quarterly thresholds (95% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r if(eval11){get_Q1_22_num_contracts_on_target(level = "STP", region_STP_name = STP11)}`**
contracts (
**`r if(eval11){round(get_Q1_22_num_contracts_on_target(level = "STP", region_STP_name = STP11)*100/get_num_contracts(level = "STP", region_STP_name = STP11))}` %**
) have delivered the required UDAs or more to be on track towards the Q1 threshold (95%) by the end of June 2022.
...
**`r get_num_contracts(data = UOA_calendar_data, remove_prototypes = T, scheduled_data = UOA_scheduled_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = region)`**
...
* This graph shows the average monthly performance of the
**`r get_num_contracts(data = UOA_calendar_data, remove_prototypes = T, scheduled_data = UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP1)`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
* N.B. Previous month's delivery may be marginally different to what was reported last month
due to the nature of calendar data (see slide 3). This month's figure is likely to be under-reported.
...
* This graph shows the average monthly performance of the
**`r get_num_contracts(data = UOA_calendar_data, remove_prototypes = T, scheduled_data = UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP2)`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
* N.B. Previous month's delivery may be marginally different to what was reported last month
due to the nature of calendar data (see slide 3). This month's figure is likely to be under-reported.
...
* This graph shows the average monthly performance of the
**`r get_num_contracts(data = UOA_calendar_data, remove_prototypes = T, scheduled_data = UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP3)`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
* N.B. Previous month's delivery may be marginally different to what was reported last month
due to the nature of calendar data (see slide 3). This month's figure is likely to be under-reported.
...
* This graph shows the average monthly performance of the
**`r if(eval4){get_num_contracts(data = UOA_calendar_data, remove_prototypes = T, scheduled_data = UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP4)}`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
* N.B. Previous month's delivery may be marginally different to what was reported last month
due to the nature of calendar data (see slide 3). This month's figure is likely to be under-reported.
...
* This graph shows the average monthly performance of the
**`r if(eval5){get_num_contracts(data = UOA_calendar_data, remove_prototypes = T, scheduled_data = UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP5)}`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
* N.B. Previous month's delivery may be marginally different to what was reported last month
due to the nature of calendar data (see slide 3). This month's figure is likely to be under-reported.
...
* This graph shows the average monthly performance of the
**`r if(eval6){get_num_contracts(data = UOA_calendar_data, remove_prototypes = T, scheduled_data = UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP6)}`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
* N.B. Previous month's delivery may be marginally different to what was reported last month
due to the nature of calendar data (see slide 3). This month's figure is likely to be under-reported.
...
* This graph shows the average monthly performance of the
**`r if(eval7){get_num_contracts(data = UOA_calendar_data, remove_prototypes = T, scheduled_data = UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP7)}`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
* N.B. Previous month's delivery may be marginally different to what was reported last month
due to the nature of calendar data (see slide 3). This month's figure is likely to be under-reported.
...
* This graph shows the average monthly performance of the
**`r if(eval8){get_num_contracts(data = UOA_calendar_data, remove_prototypes = T, scheduled_data = UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP8)}`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
* N.B. Previous month's delivery may be marginally different to what was reported last month
due to the nature of calendar data (see slide 3). This month's figure is likely to be under-reported.
...
* This graph shows the average monthly performance of the
**`r if(eval9){get_num_contracts(data = UOA_calendar_data, remove_prototypes = T, scheduled_data = UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP9)}`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
* N.B. Previous month's delivery may be marginally different to what was reported last month
due to the nature of calendar data (see slide 3). This month's figure is likely to be under-reported.
...
* This graph shows the average monthly performance of the
**`r if(eval10){get_num_contracts(data = UOA_calendar_data, remove_prototypes = T, scheduled_data = UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP10)}`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
* N.B. Previous month's delivery may be marginally different to what was reported last month
due to the nature of calendar data (see slide 3). This month's figure is likely to be under-reported.
...
* This graph shows the average monthly performance of the
**`r if(eval11){get_num_contracts(data = UOA_calendar_data, remove_prototypes = T, scheduled_data = UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP11)}`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
* N.B. Previous month's delivery may be marginally different to what was reported last month
due to the nature of calendar data (see slide 3). This month's figure is likely to be under-reported.
...
name: calendar-uoa-activity-my-cat
...
* This graph shows the cumulative activity by quarter of the **`r get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "Regional", region_STP_name = region)`**
...
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = region)`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = region)*100/get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "Regional", region_STP_name = region))` %**
...
* This graph shows the cumulative activity by quarter of the **`r get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "STP", region_STP_name = STP1)`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP1)`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP1)*100/get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "STP", region_STP_name = STP1))` %**
) have delivered the required UOAs or more to be on track towards the Q1 threshold (100%) by the end of June 2022.
...
* This graph shows the cumulative activity by quarter of the **`r get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "STP", region_STP_name = STP2)`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP2)`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP2)*100/get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "STP", region_STP_name = STP2))` %**
) have delivered the required UOAs or more to be on track towards the Q1 threshold (100%) by the end of June 2022.
...
* This graph shows the cumulative activity by quarter of the **`r get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "STP", region_STP_name = STP3)`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP3)`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP3)*100/get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "STP", region_STP_name = STP3))` %**
) have delivered the required UOAs or more to be on track towards the Q1 threshold (100%) by the end of June 2022.
...
* This graph shows the cumulative activity by quarter of the **`r if(eval4){get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "STP", region_STP_name = STP4)}`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r if(eval4){get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP4)}`**
contracts (
**`r if(eval4){round(get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP4)*100/get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "STP", region_STP_name = STP4))}` %**
) have delivered the required UOAs or more to be on track towards the Q1 threshold (100%) by the end of June 2022.
...
* This graph shows the cumulative activity by quarter of the **`r if(eval5){get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "STP", region_STP_name = STP5)}`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r if(eval5){get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP5)}`**
contracts (
**`r if(eval5){round(get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP5)*100/get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "STP", region_STP_name = STP5))}` %**
) have delivered the required UOAs or more to be on track towards the Q1 threshold (100%) by the end of June 2022.
...
* This graph shows the cumulative activity by quarter of the **`r if(eval6){get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "STP", region_STP_name = STP6)}`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r if(eval6){get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP6)}`**
contracts (
**`r if(eval6){round(get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP6)*100/get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "STP", region_STP_name = STP6))}` %**
) have delivered the required UOAs or more to be on track towards the Q1 threshold (100%) by the end of June 2022.
...
* This graph shows the cumulative activity by quarter of the **`r if(eval7){get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "STP", region_STP_name = STP7)}`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r if(eval7){get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP7)}`**
contracts (
**`r if(eval7){round(get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP7)*100/get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "STP", region_STP_name = STP7))}` %**
) have delivered the required UOAs or more to be on track towards the Q1 threshold (100%) by the end of June 2022.
...
* This graph shows the cumulative activity by quarter of the **`r if(eval8){get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "STP", region_STP_name = STP8)}`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r if(eval8){get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP8)}`**
contracts (
**`r if(eval8){round(get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP8)*100/get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "STP", region_STP_name = STP8))}` %**
) have delivered the required UOAs or more to be on track towards the Q1 threshold (100%) by the end of June 2022.
...
* This graph shows the cumulative activity by quarter of the **`r if(eval9){get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "STP", region_STP_name = STP9)}`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r if(eval9){get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP9)}`**
contracts (
**`r if(eval9){round(get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP9)*100/get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "STP", region_STP_name = STP9))}` %**
) have delivered the required UOAs or more to be on track towards the Q1 threshold (100%) by the end of June 2022.
...
* This graph shows the cumulative activity by quarter of the **`r if(eval10){get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "STP", region_STP_name = STP10)}`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r if(eval10){get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP10)}`**
contracts (
**`r if(eval10){round(get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP10)*100/get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "STP", region_STP_name = STP10))}` %**
) have delivered the required UOAs or more to be on track towards the Q1 threshold (100%) by the end of June 2022.
...
* This graph shows the cumulative activity by quarter of the **`r if(eval11){get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "STP", region_STP_name = STP11)}`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r if(eval11){get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP11)}`**
contracts (
**`r if(eval11){round(get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP11)*100/get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "STP", region_STP_name = STP11))}` %**
) have delivered the required UOAs or more to be on track towards the Q1 threshold (100%) by the end of June 2022.
...
was
**`r get_num_urgent_forms(level = "Regional", region_STP_name = region)`**
, whilst in
**`r format(Sys.Date() - lubridate::weeks(4), "%B")` 2019**
this number was
**`r get_num_urgent_forms_2019(level = "Regional", region_STP_name = region)`**
, which is a
**`r round((get_num_urgent_forms(level = "Regional", region_STP_name = region) - get_num_urgent_forms_2019(level = "Regional", region_STP_name = region)) *100 / get_num_urgent_forms_2019(level = "Regional", region_STP_name = region))` %**
...
was
**`r get_num_urgent_forms(level = "STP", region_STP_name =STP1)`**
, whilst in
**`r format(Sys.Date() - lubridate::weeks(4), "%B")` 2019**
this number was
**`r get_num_urgent_forms_2019(level = "STP", region_STP_name =STP1)`**
, which is a
**`r round((get_num_urgent_forms(level = "STP", region_STP_name =STP1) - get_num_urgent_forms_2019(level = "STP", region_STP_name =STP1)) *100 / get_num_urgent_forms_2019(level = "STP", region_STP_name =STP1))` %**
change from the pre-COVID world.
...
**`r format(Sys.Date() - lubridate::weeks(4), "%B")` 2021**
was
**`r get_num_urgent_forms(level = "STP", region_STP_name =STP2)`**
, whilst in
**`r format(Sys.Date() - lubridate::weeks(4), "%B")` 2019**
this number was
**`r get_num_urgent_forms_2019(level = "STP", region_STP_name =STP2)`**
, which is a
**`r round((get_num_urgent_forms(level = "STP", region_STP_name =STP2) - get_num_urgent_forms_2019(level = "STP", region_STP_name =STP2)) *100 / get_num_urgent_forms_2019(level = "STP", region_STP_name =STP2))` %**
change from the pre-COVID world.
...
**`r format(Sys.Date() - lubridate::weeks(4), "%B")` 2021**
was
**`r get_num_urgent_forms(level = "STP", region_STP_name =STP3)`**
, whilst in
**`r format(Sys.Date() - lubridate::weeks(4), "%B")` 2019**
this number was
**`r get_num_urgent_forms_2019(level = "STP", region_STP_name =STP3)`**
, which is a
**`r round((get_num_urgent_forms(level = "STP", region_STP_name =STP3) - get_num_urgent_forms_2019(level = "STP", region_STP_name =STP3)) *100 / get_num_urgent_forms_2019(level = "STP", region_STP_name =STP3))` %**
change from the pre-COVID world.
...
**`r format(Sys.Date() - lubridate::weeks(4), "%B")` 2021**
was
**`r if(eval4){get_num_urgent_forms(level = "STP", region_STP_name = STP4)}`**
, whilst in
**`r if(eval4){format(Sys.Date() - lubridate::weeks(4), "%B")}` 2019**
this number was
**`r if(eval4){get_num_urgent_forms_2019(level = "STP", region_STP_name = STP4)}`**
, which is a
**`r if(eval4){round((get_num_urgent_forms(level = "STP", region_STP_name = STP4) - get_num_urgent_forms_2019(level = "STP", region_STP_name = STP4)) *100 / get_num_urgent_forms_2019(level = "STP", region_STP_name = STP4))}` %**
change from the pre-COVID world.
...
**`r format(Sys.Date() - lubridate::weeks(4), "%B")` 2021**
was
**`r if(eval5){get_num_urgent_forms(level = "STP", region_STP_name = STP5)}`**
, whilst in
**`r if(eval5){format(Sys.Date() - lubridate::weeks(4), "%B")}` 2019**
this number was
**`r if(eval5){get_num_urgent_forms_2019(level = "STP", region_STP_name = STP5)}`**
, which is a
**`r if(eval5){round((get_num_urgent_forms(level = "STP", region_STP_name = STP5) - get_num_urgent_forms_2019(level = "STP", region_STP_name = STP5)) *100 / get_num_urgent_forms_2019(level = "STP", region_STP_name = STP5))}` %**
change from the pre-COVID world.
...
**`r format(Sys.Date() - lubridate::weeks(4), "%B")` 2021**
was
**`r if(eval6){get_num_urgent_forms(level = "STP", region_STP_name = STP6)}`**
, whilst in
**`r if(eval6){format(Sys.Date() - lubridate::weeks(4), "%B")}` 2019**
this number was
**`r if(eval6){get_num_urgent_forms_2019(level = "STP", region_STP_name = STP6)}`**
, which is a
**`r if(eval6){round((get_num_urgent_forms(level = "STP", region_STP_name = STP6) - get_num_urgent_forms_2019(level = "STP", region_STP_name = STP6)) *100 / get_num_urgent_forms_2019(level = "STP", region_STP_name = STP6))}` %**
change from the pre-COVID world.
...
**`r format(Sys.Date() - lubridate::weeks(4), "%B")` 2021**
was
**`r if(eval7){get_num_urgent_forms(level = "STP", region_STP_name = STP7)}`**
, whilst in
**`r if(eval7){format(Sys.Date() - lubridate::weeks(4), "%B")}` 2019**
this number was
**`r if(eval7){get_num_urgent_forms_2019(level = "STP", region_STP_name = STP7)}`**
, which is a
**`r if(eval7){round((get_num_urgent_forms(level = "STP", region_STP_name = STP7) - get_num_urgent_forms_2019(level = "STP", region_STP_name = STP7)) *100 / get_num_urgent_forms_2019(level = "STP", region_STP_name = STP7))}` %**
change from the pre-COVID world.
...
**`r format(Sys.Date() - lubridate::weeks(4), "%B")` 2021**
was
**`r if(eval8){get_num_urgent_forms(level = "STP", region_STP_name = STP8)}`**
, whilst in
**`r if(eval8){format(Sys.Date() - lubridate::weeks(4), "%B")}` 2019**
this number was
**`r if(eval8){get_num_urgent_forms_2019(level = "STP", region_STP_name = STP8)}`**
, which is a
**`r if(eval8){round((get_num_urgent_forms(level = "STP", region_STP_name = STP8) - get_num_urgent_forms_2019(level = "STP", region_STP_name = STP8)) *100 / get_num_urgent_forms_2019(level = "STP", region_STP_name = STP8))}` %**
change from the pre-COVID world.
...
**`r format(Sys.Date() - lubridate::weeks(4), "%B")` 2021**
was
**`r if(eval9){get_num_urgent_forms(level = "STP", region_STP_name = STP9)}`**
, whilst in
**`r if(eval9){format(Sys.Date() - lubridate::weeks(4), "%B")}` 2019**
this number was
**`r if(eval9){get_num_urgent_forms_2019(level = "STP", region_STP_name = STP9)}`**
, which is a
**`r if(eval9){round((get_num_urgent_forms(level = "STP", region_STP_name = STP9) - get_num_urgent_forms_2019(level = "STP", region_STP_name = STP9)) *100 / get_num_urgent_forms_2019(level = "STP", region_STP_name = STP9))}` %**
change from the pre-COVID world.
...
**`r format(Sys.Date() - lubridate::weeks(4), "%B")` 2021**
was
**`r if(eval10){get_num_urgent_forms(level = "STP", region_STP_name = STP10)}`**
, whilst in
**`r if(eval10){format(Sys.Date() - lubridate::weeks(4), "%B")}` 2019**
this number was
**`r if(eval10){get_num_urgent_forms_2019(level = "STP", region_STP_name = STP10)}`**
, which is a
**`r if(eval10){round((get_num_urgent_forms(level = "STP", region_STP_name = STP10) - get_num_urgent_forms_2019(level = "STP", region_STP_name = STP10)) *100 / get_num_urgent_forms_2019(level = "STP", region_STP_name = STP10))}` %**
change from the pre-COVID world.
...
**`r format(Sys.Date() - lubridate::weeks(4), "%B")` 2021**
was
**`r if(eval11){get_num_urgent_forms(level = "STP", region_STP_name = STP11)}`**
, whilst in
**`r if(eval11){format(Sys.Date() - lubridate::weeks(4), "%B")}` 2019**
this number was
**`r if(eval11){get_num_urgent_forms_2019(level = "STP", region_STP_name = STP11)}`**
, which is a
**`r if(eval11){round((get_num_urgent_forms(level = "STP", region_STP_name = STP11) - get_num_urgent_forms_2019(level = "STP", region_STP_name = STP11)) *100 / get_num_urgent_forms_2019(level = "STP", region_STP_name = STP11))}` %**
change from the pre-COVID world.
...
**`r plot_unique_patients_rolling(level = "Regional",region_STP_name = region, plotChart = F,remove_prototypes = T, get_perc = T)` %**
...
* The number of unique patients seen in the last 12 months is currently around
**`r plot_unique_patients_rolling(level = "STP",region_STP_name = STP1, plotChart = F,remove_prototypes = T, get_perc = T)` %**
of pre-pandemic levels.
...
* The number of unique patients seen in the last 12 months is currently around
**`r plot_unique_patients_rolling(level = "STP",region_STP_name = STP3, plotChart = F,remove_prototypes = T, get_perc = T)` %**
of pre-pandemic levels.
...
* The number of unique patients seen in the last 12 months is currently around
**`r if(eval4){plot_unique_patients_rolling(level = "STP",region_STP_name = STP4, plotChart = F,remove_prototypes = T, get_perc = T)}` %**
of pre-pandemic levels.
...
* The number of unique patients seen in the last 12 months is currently around
**`r if(eval5){plot_unique_patients_rolling(level = "STP",region_STP_name = STP5, plotChart = F,remove_prototypes = T, get_perc = T)}` %**
of pre-pandemic levels.
...
* The number of unique patients seen in the last 12 months is currently around
**`r if(eval6){plot_unique_patients_rolling(level = "STP",region_STP_name = STP6, plotChart = F,remove_prototypes = T, get_perc = T)}` %**
of pre-pandemic levels.
...
* The number of unique patients seen in the last 12 months is currently around
**`r if(eval7){plot_unique_patients_rolling(level = "STP",region_STP_name = STP7, plotChart = F,remove_prototypes = T, get_perc = T)}` %**
of pre-pandemic levels.
...
* The number of unique patients seen in the last 12 months is currently around
**`r if(eval8){plot_unique_patients_rolling(level = "STP",region_STP_name = STP8, plotChart = F,remove_prototypes = T, get_perc = T)}` %**
of pre-pandemic levels.
...
* The number of unique patients seen in the last 12 months is currently around
**`r if(eval9){plot_unique_patients_rolling(level = "STP",region_STP_name = STP9, plotChart = F,remove_prototypes = T, get_perc = T)}` %**
of pre-pandemic levels.
...
* The number of unique patients seen in the last 12 months is currently around
**`r if(eval10){plot_unique_patients_rolling(level = "STP",region_STP_name = STP10, plotChart = F,remove_prototypes = T, get_perc = T)}` %**
of pre-pandemic levels.
...
* The number of unique patients seen in the last 12 months is currently around
**`r if(eval11){plot_unique_patients_rolling(level = "STP",region_STP_name = STP11, plotChart = F,remove_prototypes = T, get_perc = T)}` %**
of pre-pandemic levels.
...
### Unique dental patients seen as a precentage of April 2018 figures
...
name: num-contracts-trend

### Number of contracts trend

```{r xaringan-panelset-num-contracts-trend, echo=FALSE}
xaringanExtra::use_panelset()
```
...
```{r echo = FALSE, warning = FALSE, message = FALSE, fig.width=14, fig.height=5}
plot_number_of_contracts_over_time(data = UDA_scheduled_data,
...
The percentage change in total number of contracts from `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2018 to `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2022 is
**`r plot_number_of_contracts_over_time(data = UDA_scheduled_data, historical_data = historical_UDA_scheduled_data,level = "Regional",region_STP_name = region,plotChart = FALSE, getChange = TRUE)`%**.
 ]
 .panel[.panel-name[`r STP1`]

```{r echo = FALSE, warning = FALSE, message = FALSE, fig.width=14, fig.height=5}
plot_number_of_contracts_over_time(data = UDA_scheduled_data, historical_data = historical_UDA_scheduled_data,
                                level = "STP",
                                region_STP_name = STP1,
                                plotChart = TRUE)
```
...
The percentage change in total number of contracts from `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2018 to `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2022 is
**`r plot_number_of_contracts_over_time(data = UDA_scheduled_data, historical_data = historical_UDA_scheduled_data,level = "STP",region_STP_name = STP1,plotChart = FALSE, getChange = TRUE)`%**.
 ]
 .panel[.panel-name[`r STP2`]
```{r echo = FALSE, warning = FALSE, message = FALSE, fig.width=14, fig.height=5}
plot_number_of_contracts_over_time(data = UDA_scheduled_data, historical_data = historical_UDA_scheduled_data,
...
The percentage change in total number of contracts from `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2018 to `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2022 is
**`r plot_number_of_contracts_over_time(data = UDA_scheduled_data, historical_data = historical_UDA_scheduled_data,level = "STP",region_STP_name = STP2,plotChart = FALSE, getChange = TRUE)`%**.
...
The percentage change in total number of contracts from `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2018 to `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2022 is
**`r plot_number_of_contracts_over_time(data = UDA_scheduled_data, historical_data = historical_UDA_scheduled_data,level = "STP",region_STP_name = STP3,plotChart = FALSE, getChange = TRUE)`%**.
...
```
 ...
 The dips seen every April are most likely due to the fact that new contracts starting at the beginning of the financial year will not have submitted any FP17s until May, which means that they will not show up in the data until May.
...
```{r xaringan-panelset-contracted-UDAs-trend, echo=FALSE}
xaringanExtra::use_panelset()
```
...
The percentage change in total number of contracts from `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2018 to `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2022 is
**`r plot_UDAs_commissioned(data = UDA_scheduled_data, historical_data = historical_UDA_scheduled_data,level = "Regional",region_STP_name = region,plotChart = FALSE, getChange = TRUE)`%**.
 ]
 .panel[.panel-name[`r STP1`]
...
The percentage change in total number of contracts from `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2018 to `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2022 is
**`r plot_UDAs_commissioned(data = UDA_scheduled_data, historical_data = historical_UDA_scheduled_data,level = "STP",region_STP_name = STP1,plotChart = FALSE, getChange = TRUE)`%**.
 ]
 .panel[.panel-name[`r STP2`]
```{r echo = FALSE, warning = FALSE, message = FALSE, fig.width=14, fig.height=5}
plot_UDAs_commissioned(data = UDA_scheduled_data, historical_data = historical_UDA_scheduled_data,
...
The percentage change in total number of contracts from `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2018 to `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2022 is
**`r plot_UDAs_commissioned(data = UDA_scheduled_data, historical_data = historical_UDA_scheduled_data,level = "STP",region_STP_name = STP2,plotChart = FALSE, getChange = TRUE)`%**.
...
The percentage change in total number of contracts from `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2018 to `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2022 is
**`r plot_UDAs_commissioned(data = UDA_scheduled_data, historical_data = historical_UDA_scheduled_data,level = "STP",region_STP_name = STP3,plotChart = FALSE, getChange = TRUE)`%**.
...
The dips seen every April are most likely due to changes to the contracted UDAs by commissioners, following performance reviews at the end of the financial year. It may also be that new contracts starting at the beginning of the financial year will not have submitted any FP17s until May, which means that their contracted UDA data will not show up until May.
...
### Financial value of UDAs delivered
...
```{r echo = FALSE, warning = FALSE, message = FALSE, fig.width=14, fig.height=5}
plot_UDA_value(data = UDA_scheduled_data,
                           historical_data = historical_UDA_scheduled_data,
...
name: uda-value-index

### Financial value of UDAs delivered as % of 2018 delivery

```{r xaringan-panelset-uda-value-index, echo=FALSE}
xaringanExtra::use_panelset()
```
