...
**`r get_num_contracts(data = UOA_scheduled_data, remove_prototypes = T, calendar_data = UOA_calendar_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = region)`**
...
* This graph shows the average monthly performance of the
**`r get_num_contracts(data = UOA_scheduled_data, remove_prototypes = T, calendar_data = UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP1)`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
...
* This graph shows the average monthly performance of the
**`r get_num_contracts(data = UOA_scheduled_data, remove_prototypes = T, calendar_data = UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP2)`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
...
* This graph shows the average monthly performance of the
**`r get_num_contracts(data = UOA_scheduled_data, remove_prototypes = T, calendar_data = UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP3)`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
...
* This graph shows the average monthly performance of the
**`r if(eval4){get_num_contracts(data = UOA_scheduled_data, remove_prototypes = T, calendar_data = UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP4)}`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
...
* This graph shows the average monthly performance of the
**`r if(eval5){get_num_contracts(data = UOA_scheduled_data, remove_prototypes = T, calendar_data = UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP5)}`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
...
* This graph shows the average monthly performance of the
**`r if(eval6){get_num_contracts(data = UOA_scheduled_data, remove_prototypes = T, calendar_data = UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP6)}`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
...
* This graph shows the average monthly performance of the
**`r if(eval7){get_num_contracts(data = UOA_scheduled_data, remove_prototypes = T, calendar_data = UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP7)}`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
...
* This graph shows the average monthly performance of the
**`r if(eval8){get_num_contracts(data = UOA_scheduled_data, remove_prototypes = T, calendar_data = UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP8)}`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
...
* This graph shows the average monthly performance of the
**`r if(eval9){get_num_contracts(data = UOA_scheduled_data, remove_prototypes = T, calendar_data = UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP9)}`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
...
* This graph shows the average monthly performance of the
**`r if(eval10){get_num_contracts(data = UOA_scheduled_data, remove_prototypes = T, calendar_data = UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP10)}`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
...
* This graph shows the average monthly performance of the
**`r if(eval11){get_num_contracts(data = UOA_scheduled_data, remove_prototypes = T, calendar_data = UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP11)}`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
...
.panelset[
 ...
 .panel[.panel-name[`r region`]
```{r echo = FALSE, warning = FALSE, message = FALSE, fig.width=14, fig.height=5}
plot_UDA_UOA_delivery_MY_cat(calendar_data = UOA_calendar_data,
...
* This graph shows the cumulative activity by quarter of the **`r get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "Regional", region_STP_name = region)`**
...
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(UOA_scheduled_data, UOA_calendar_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = region)`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(UOA_scheduled_data, UOA_calendar_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = region)*100/get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "Regional", region_STP_name = region))` %**
...
* This graph shows the cumulative activity by quarter of the **`r get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "STP", region_STP_name = STP1)`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(UOA_scheduled_data, UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP1)`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(UOA_scheduled_data, UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP1)*100/get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "STP", region_STP_name = STP1))` %**
) have delivered the required UOAs or more to be on track towards the Q2 threshold (100%) by the end of September 2022.
...
* This graph shows the cumulative activity by quarter of the **`r get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "STP", region_STP_name = STP2)`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(UOA_scheduled_data, UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP2)`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(UOA_scheduled_data, UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP2)*100/get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "STP", region_STP_name = STP2))` %**
) have delivered the required UOAs or more to be on track towards the Q2 threshold (100%) by the end of September 2022.
...
* This graph shows the cumulative activity by quarter of the **`r get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "STP", region_STP_name = STP3)`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(UOA_scheduled_data, UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP3)`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(UOA_scheduled_data, UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP3)*100/get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "STP", region_STP_name = STP3))` %**
) have delivered the required UOAs or more to be on track towards the Q2 threshold (100%) by the end of September 2022.
...
* This graph shows the cumulative activity by quarter of the **`r if(eval4){get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "STP", region_STP_name = STP4)}`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r if(eval4){get_Q1_22_num_contracts_on_target(UOA_scheduled_data, UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP4)}`**
contracts (
**`r if(eval4){round(get_Q1_22_num_contracts_on_target(UOA_scheduled_data, UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP4)*100/get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "STP", region_STP_name = STP4))}` %**
) have delivered the required UOAs or more to be on track towards the Q2 threshold (100%) by the end of September 2022.
...
* This graph shows the cumulative activity by quarter of the **`r if(eval5){get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "STP", region_STP_name = STP5)}`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r if(eval5){get_Q1_22_num_contracts_on_target(UOA_scheduled_data, UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP5)}`**
contracts (
**`r if(eval5){round(get_Q1_22_num_contracts_on_target(UOA_scheduled_data, UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP5)*100/get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "STP", region_STP_name = STP5))}` %**
) have delivered the required UOAs or more to be on track towards the Q2 threshold (100%) by the end of September 2022.
...
* This graph shows the cumulative activity by quarter of the **`r if(eval6){get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "STP", region_STP_name = STP6)}`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r if(eval6){get_Q1_22_num_contracts_on_target(UOA_scheduled_data, UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP6)}`**
contracts (
**`r if(eval6){round(get_Q1_22_num_contracts_on_target(UOA_scheduled_data, UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP6)*100/get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "STP", region_STP_name = STP6))}` %**
) have delivered the required UOAs or more to be on track towards the Q2 threshold (100%) by the end of September 2022.
...
* This graph shows the cumulative activity by quarter of the **`r if(eval7){get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "STP", region_STP_name = STP7)}`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r if(eval7){get_Q1_22_num_contracts_on_target(UOA_scheduled_data, UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP7)}`**
contracts (
**`r if(eval7){round(get_Q1_22_num_contracts_on_target(UOA_scheduled_data, UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP7)*100/get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "STP", region_STP_name = STP7))}` %**
) have delivered the required UOAs or more to be on track towards the Q2 threshold (100%) by the end of September 2022.
...
* This graph shows the cumulative activity by quarter of the **`r if(eval8){get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "STP", region_STP_name = STP8)}`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r if(eval8){get_Q1_22_num_contracts_on_target(UOA_scheduled_data, UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP8)}`**
contracts (
**`r if(eval8){round(get_Q1_22_num_contracts_on_target(UOA_scheduled_data, UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP8)*100/get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "STP", region_STP_name = STP8))}` %**
) have delivered the required UOAs or more to be on track towards the Q2 threshold (100%) by the end of September 2022.
...
* This graph shows the cumulative activity by quarter of the **`r if(eval9){get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "STP", region_STP_name = STP9)}`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r if(eval9){get_Q1_22_num_contracts_on_target(UOA_scheduled_data, UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP9)}`**
contracts (
**`r if(eval9){round(get_Q1_22_num_contracts_on_target(UOA_scheduled_data, UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP9)*100/get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "STP", region_STP_name = STP9))}` %**
) have delivered the required UOAs or more to be on track towards the Q2 threshold (100%) by the end of September 2022.
...
* This graph shows the cumulative activity by quarter of the **`r if(eval10){get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "STP", region_STP_name = STP10)}`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r if(eval10){get_Q1_22_num_contracts_on_target(UOA_scheduled_data, UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP10)}`**
contracts (
**`r if(eval10){round(get_Q1_22_num_contracts_on_target(UOA_scheduled_data, UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP10)*100/get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "STP", region_STP_name = STP10))}` %**
) have delivered the required UOAs or more to be on track towards the Q2 threshold (100%) by the end of September 2022.
...
* This graph shows the cumulative activity by quarter of the **`r if(eval11){get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "STP", region_STP_name = STP11)}`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r if(eval11){get_Q1_22_num_contracts_on_target(UOA_scheduled_data, UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP11)}`**
contracts (
**`r if(eval11){round(get_Q1_22_num_contracts_on_target(UOA_scheduled_data, UOA_calendar_data, UDAorUOA = "UOA", level = "STP", region_STP_name = STP11)*100/get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "STP", region_STP_name = STP11))}` %**
) have delivered the required UOAs or more to be on track towards the Q2 threshold (100%) by the end of September 2022.
