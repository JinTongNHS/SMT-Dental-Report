 ...
 * [Practice closures based on PCAR report](#closures)
...
<font size="2">
Full scheduled delivery data back to 2016 can be found on [slide 9](#historic-udas).
]
]
...
data <- plot_UDA_UOA_delivery_MY_cat(calendar_data = UDA_calendar_data,
                             data = UDA_scheduled_data,
                                  contractor_cats = contractor_categories,
                                  UDAorUOA = "UDA",
                                  level = "National",
...
data %>%
  download_this(
    output_name = "UDA_delivery_calendar_by_MY_category_excl_prototypes_data",
    output_extension = ".xlsx",
    button_label = "Download data",
    button_type = "warning",
    has_icon = TRUE,
...
contracts measured against the expected monthly total activity to achieve the quarterly thresholds (95% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(level = "Regional", region_STP_name = "South East")`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(level = "Regional", region_STP_name = "South East")*100/get_num_contracts(level = "Regional", region_STP_name = "South East"))` %**
) have delivered the required UDAs or more to be on track towards the Q2 threshold (100%) by the end of September 2022.
...
contracts measured against the expected monthly total activity to achieve the quarterly thresholds (95% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(level = "Regional", region_STP_name = "South West")`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(level = "Regional", region_STP_name = "South West")*100/get_num_contracts(level = "Regional", region_STP_name = "South West"))` %**
) have delivered the required UDAs or more to be on track towards the Q2 threshold (100%) by the end of September 2022.
...
contracts measured against the expected monthly total activity to achieve the quarterly thresholds (95% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(level = "Regional", region_STP_name = "North West")`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(level = "Regional", region_STP_name = "North West")*100/get_num_contracts(level = "Regional", region_STP_name = "North West"))` %**
) have delivered the required UDAs or more to be on track towards the Q2 threshold (100%) by the end of September 2022.
...
contracts measured against the expected monthly total activity to achieve the quarterly thresholds (95% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(level = "Regional", region_STP_name = "North East and Yorkshire")`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(level = "Regional", region_STP_name = "North East and Yorkshire")*100/get_num_contracts(level = "Regional", region_STP_name = "North East and Yorkshire"))` %**
) have delivered the required UDAs or more to be on track towards the Q2 threshold (100%) by the end of September 2022.
...
contracts measured against the expected monthly total activity to achieve the quarterly thresholds (95% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(level = "Regional", region_STP_name = "London")`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(level = "Regional", region_STP_name = "London")*100/get_num_contracts(level = "Regional", region_STP_name = "London"))` %**
) have delivered the required UDAs or more to be on track towards the Q2 threshold (100%) by the end of September 2022.
...
contracts measured against the expected monthly total activity to achieve the quarterly thresholds (95% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(level = "Regional", region_STP_name = "Midlands")`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(level = "Regional", region_STP_name = "Midlands")*100/get_num_contracts(level = "Regional", region_STP_name = "Midlands"))` %**
) have delivered the required UDAs or more to be on track towards the Q2 threshold (100%) by the end of September 2022.
...
contracts measured against the expected monthly total activity to achieve the quarterly thresholds (95% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(level = "Regional", region_STP_name = "East of England")`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(level = "Regional", region_STP_name = "East of England")*100/get_num_contracts(level = "Regional", region_STP_name = "East of England"))` %**
) have delivered the required UDAs or more to be on track towards the Q2 threshold (100%) by the end of September 2022.
...
* This graph shows the average monthly performance of the
**`r get_num_contracts(data = UOA_scheduled_data, remove_prototypes = T, calendar_data = UOA_calendar_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "South East")`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
...
* This graph shows the average monthly performance of the
**`r get_num_contracts(data = UOA_scheduled_data, remove_prototypes = T, calendar_data = UOA_calendar_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "South West")`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
...
* This graph shows the average monthly performance of the
**`r get_num_contracts(data = UOA_scheduled_data, remove_prototypes = T, calendar_data = UOA_calendar_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "North West")`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
...
* This graph shows the average monthly performance of the
**`r get_num_contracts(data = UOA_scheduled_data, remove_prototypes = T, calendar_data = UOA_calendar_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "North East and Yorkshire")`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
...
* This graph shows the average monthly performance of the
**`r get_num_contracts(data = UOA_scheduled_data, remove_prototypes = T, calendar_data = UOA_calendar_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "London")`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
...
* This graph shows the average monthly performance of the
**`r get_num_contracts(data = UOA_scheduled_data, remove_prototypes = T, calendar_data = UOA_calendar_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "Midlands")`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
...
* This graph shows the average monthly performance of the
**`r get_num_contracts(data = UOA_scheduled_data, remove_prototypes = T, calendar_data = UOA_calendar_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "East of England")`**
GDS/PDS contracts scaled up by 12 months measured against the delivery thresholds (80% for Apr-Sep 21, 85% for Oct-Dec, 90% for Jan-Mar, 100% for Apr-Jun 22).
...
data <- plot_UDA_UOA_delivery_MY_cat(calendar_data = UOA_calendar_data,
                             data = UOA_scheduled_data,
                                  contractor_cats = contractor_categories,
                                  UDAorUOA = "UOA",
                                  level = "National",
...
* This graph shows the cumulative activity by quarter of the **`r get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "Regional", region_STP_name = "South East")`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "South East")`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "South East")*100/get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "Regional", region_STP_name = "South East"))` %**
) have delivered the required UOAs or more to be on track towards the Q2 threshold (100%) by the end of September 2022.
...
* This graph shows the cumulative activity by quarter of the **`r get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "Regional", region_STP_name = "South West")`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "South West")`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "South West")*100/get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "Regional", region_STP_name = "South West"))` %**
) have delivered the required UOAs or more to be on track towards the Q2 threshold (100%) by the end of September 2022.
...
* This graph shows the cumulative activity by quarter of the **`r get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "Regional", region_STP_name = "North West")`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "North West")`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "North West")*100/get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "Regional", region_STP_name = "North West"))` %**
) have delivered the required UOAs or more to be on track towards the Q2 threshold (100%) by the end of September 2022.
...
* This graph shows the cumulative activity by quarter of the **`r get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "Regional", region_STP_name = "North East and Yorkshire")`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "North East and Yorkshire")`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "North East and Yorkshire")*100/get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "Regional", region_STP_name = "North East and Yorkshire"))` %**
) have delivered the required UOAs or more to be on track towards the Q2 threshold (100%) by the end of September 2022.
...
* This graph shows the cumulative activity by quarter of the **`r get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "Regional", region_STP_name = "London")`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "London")`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "London")*100/get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "Regional", region_STP_name = "London"))` %**
) have delivered the required UOAs or more to be on track towards the Q2 threshold (100%) by the end of September 2022.
...
* This graph shows the cumulative activity by quarter of the **`r get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "Regional", region_STP_name = "Midlands")`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "Midlands")`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "Midlands")*100/get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "Regional", region_STP_name = "Midlands"))` %**
) have delivered the required UOAs or more to be on track towards the Q2 threshold (100%) by the end of September 2022.
...
* This graph shows the cumulative activity by quarter of the **`r get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "Regional", region_STP_name = "East of England")`**
GDS/PDS contracts measured against the
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "East of England")`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "East of England")*100/get_num_contracts(UOA_scheduled_data, remove_prototypes = T, UOA_calendar_data, "UOA", level = "Regional", region_STP_name = "East of England"))` %**
) have delivered the required UOAs or more to be on track towards the Q2 threshold (100%) by the end of September 2022.
...
The change in total annual contracted UDAs from `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2018 to `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2022 is
...
**`r plot_number_of_contracts_over_time(data = UDA_scheduled_data, historical_data = historical_UDA_scheduled_data,level = "National",region_STP_name = NULL,plotChart = FALSE, getChange = TRUE)`%**.
 ]
 .panel[.panel-name[South East]
...
The percentage change in total number of contracts from `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2018 to `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2022 is
**`r plot_number_of_contracts_over_time(data = UDA_scheduled_data, historical_data = historical_UDA_scheduled_data,level = "Regional",region_STP_name = "South East",plotChart = FALSE, getChange = TRUE)`%**.
 ]
 .panel[.panel-name[South West]
```{r echo = FALSE, warning = FALSE, message = FALSE, fig.width=14, fig.height=5}
plot_number_of_contracts_over_time(data = UDA_scheduled_data, historical_data = historical_UDA_scheduled_data,
...
The percentage change in total number of contracts from `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2018 to `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2022 is
**`r plot_number_of_contracts_over_time(data = UDA_scheduled_data, historical_data = historical_UDA_scheduled_data,level = "Regional",region_STP_name = "South West",plotChart = FALSE, getChange = TRUE)`%**.
...
The percentage change in total number of contracts from `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2018 to `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2022 is
**`r plot_number_of_contracts_over_time(data = UDA_scheduled_data, historical_data = historical_UDA_scheduled_data,level = "Regional",region_STP_name = "North West",plotChart = FALSE, getChange = TRUE)`%**.
...
The percentage change in total number of contracts from `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2018 to `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2022 is
**`r plot_number_of_contracts_over_time(data = UDA_scheduled_data, historical_data = historical_UDA_scheduled_data,level = "Regional",region_STP_name = "North East and Yorkshire",plotChart = FALSE, getChange = TRUE)`%**.
...
The percentage change in total number of contracts from `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2018 to `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2022 is
**`r plot_number_of_contracts_over_time(data = UDA_scheduled_data, historical_data = historical_UDA_scheduled_data,level = "Regional",region_STP_name = "London",plotChart = FALSE, getChange = TRUE)`%**.
...
The percentage change in total number of contracts from `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2018 to `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2022 is
**`r plot_number_of_contracts_over_time(data = UDA_scheduled_data, historical_data = historical_UDA_scheduled_data,level = "Regional",region_STP_name = "Midlands",plotChart = FALSE, getChange = TRUE)`%**.
...
The percentage change in total number of contracts from `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2018 to `r format(Sys.Date() - lubridate::weeks(4), "%B")` 2022 is
**`r plot_number_of_contracts_over_time(data = UDA_scheduled_data, historical_data = historical_UDA_scheduled_data,level = "Regional",region_STP_name = "East of England",plotChart = FALSE, getChange = TRUE)`%**.
...
reactable(
  ...
  groupBy = c("Month", "Region Name"),
  columns = list(
    `Financial delivery £`= colDef(aggregate = "sum", format = colFormat(digits = 0), filterable = FALSE),
    `Financial delivery £million` = colDef(aggregate = "sum", format = colFormat(digits = 0), filterable = FALSE),
    `Cumulative financial delivery £million` = colDef(aggregate = "sum", format = colFormat(digits = 0), filterable = FALSE),
    `2017/18 - 2019/20 mean financial delivery £million` = colDef(aggregate = "sum", format = colFormat(digits = 0), filterable = FALSE)
)
)
```
