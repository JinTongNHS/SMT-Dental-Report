...
### Contracts projected to deliver at least 96% of contracted UDAs

```{r xaringan-panelset-uda_projection, echo=FALSE}
xaringanExtra::use_panelset()
```
 <font size="2">
.panelset[
 ...
 .panel[.panel-name[National]
```{r echo = FALSE, warning = FALSE, message = FALSE, , fig.width=14, fig.height=5}
plot_UDA_projection(level = "National")
```
...
```{r echo = FALSE, warning = FALSE, message = FALSE, , fig.width=14, fig.height=5}
plot_UDA_projection(level = "Regional")
```
