 ...
 * [Band 2 UDA Split](#band2-split-UDAs)
...
.panelset[
 ...
 .panel[.panel-name[National]
```{r echo = FALSE, warning = FALSE, message = FALSE, , fig.width=14, fig.height=5}
plot_UDA_delivered_percent(level = "National")
```
 ...
 .panel[.panel-name[Regional]
```{r echo = FALSE, warning = FALSE, message = FALSE, , fig.width=14, fig.height=5}
plot_UDA_delivered_percent(level = "Regional")
```
...
name: band2-split-UDAs

### Band 2 Split UDAs

```{r xaringan-panelset-band2-split-UDAs, echo=FALSE}
xaringanExtra::use_panelset()
```
...
```{r echo = FALSE, warning = FALSE, message = FALSE, fig.width=14, fig.height=5}
plot_band2_split(data = band2_split_data,
                             scheduled_data = UDA_scheduled_data,
                             remove_prototypes = TRUE, 
...
data <- plot_band2_split(data = band2_split_data,
                             scheduled_data = UDA_scheduled_data,
                             remove_prototypes = TRUE, 
                             commissioner_region_lookup = STP_ICB_lookup_codes,
                                level = "National",
