...
contractor_categories <- read_excel("N:/_Everyone/Primary Care Group/SMT_Dental DENT 2022_23-008/data_for_monthly_report/contractor_categories_Jan23.xlsx") ##did not find. ##changed_ME
 ...
 * [Historic UDA activity- Treatment Data](#short-uda-activity-treatment-data)
 ...
 * [Unique patients seen rolling 12 months as % of February 2020 delivery](#unique-patients-index)
...
name: short-uda-activity-treatment-data

### Historic UDA activity- Treatment Data

```{r xaringan-panelset-UDA-activity-historic, echo=FALSE}
xaringanExtra::use_panelset()
```
 <font size="2">
.panelset[
...
.panel[.panel-name[South East]
```{r UDA_activity_Calendar21, echo = FALSE, warning = FALSE, message = FALSE, fig.width=14, fig.height=5, fig.align='center'}
plot_historic_UDA_UOA_delivery_treatment_month(data = UDA_treatment_month_non_FD,
                                               scheduled_data = UDA_scheduled_data, 
                                               historic_data = historical_UDA_scheduled_data,
                                               contractor_cats = contractor_categories,
...
.panel[.panel-name[South West]
```{r UDA_activity_Calendar31, echo = FALSE, warning = FALSE, message = FALSE, fig.width=14, fig.height=5, fig.align='center'}
plot_historic_UDA_UOA_delivery_treatment_month(data = UDA_treatment_month_non_FD,
                                               scheduled_data = UDA_scheduled_data, 
                                               historic_data = historical_UDA_scheduled_data,
                                               contractor_cats = contractor_categories,
...
.panel[.panel-name[North West]
```{r UDA_activity_Calendar41, echo = FALSE, warning = FALSE, message = FALSE, fig.width=14, fig.height=5, fig.align='center'}
plot_historic_UDA_UOA_delivery_treatment_month(data = UDA_treatment_month_non_FD,
                                               scheduled_data = UDA_scheduled_data, 
                                               historic_data = historical_UDA_scheduled_data,
                                               contractor_cats = contractor_categories,
...
.panel[.panel-name[North East and Yorkshire]
```{r UDA_activity_Calendar51, echo = FALSE, warning = FALSE, message = FALSE, fig.width=14, fig.height=5, fig.align='center'}
plot_historic_UDA_UOA_delivery_treatment_month(data = UDA_treatment_month_non_FD,
                                               scheduled_data = UDA_scheduled_data, 
                                               historic_data = historical_UDA_scheduled_data,
                                               contractor_cats = contractor_categories,
...
.panel[.panel-name[London]
```{r UDA_activity_Calendar61, echo = FALSE, warning = FALSE, message = FALSE, fig.width=14, fig.height=5, fig.align='center'}
plot_historic_UDA_UOA_delivery_treatment_month(data = UDA_treatment_month_non_FD,
                                               scheduled_data = UDA_scheduled_data, 
                                               historic_data = historical_UDA_scheduled_data,
                                               contractor_cats = contractor_categories,
...
.panel[.panel-name[Midlands]
```{r UDA_activity_Calendar71, echo = FALSE, warning = FALSE, message = FALSE, fig.width=14, fig.height=5, fig.align='center'}
plot_historic_UDA_UOA_delivery_treatment_month(data = UDA_treatment_month_non_FD,
                                               scheduled_data = UDA_scheduled_data, 
                                               historic_data = historical_UDA_scheduled_data,
                                               contractor_cats = contractor_categories,
...
.panel[.panel-name[East of England]
```{r UDA_activity_Calendar81, echo = FALSE, warning = FALSE, message = FALSE, fig.width=14, fig.height=5, fig.align='center'}
plot_historic_UDA_UOA_delivery_treatment_month(data = UDA_treatment_month_non_FD,
                                               scheduled_data = UDA_scheduled_data, 
                                               historic_data = historical_UDA_scheduled_data,
                                               contractor_cats = contractor_categories,
...
### Unique dental patients seen as percentage of February 2020 figures
...
* The number of unique patients seen in the last 12 months is currently around
**`r plot_unique_patients_rolling_as_percent_of_feb_20(level = "National",region_STP_name = NULL, plotChart = F,remove_prototypes = FALSE, get_perc = T)` %**
of pre-pandemic levels.
...
* The number of unique patients seen in the last 12 months is currently around
**`r plot_unique_patients_rolling_as_percent_of_feb_20(level = "Regional",region_STP_name = "South East", plotChart = F,remove_prototypes = FALSE, get_perc = T)` %**
of pre-pandemic levels.
...
* The number of unique patients seen in the last 12 months is currently around
**`r plot_unique_patients_rolling_as_percent_of_feb_20(level = "Regional",region_STP_name = "South West", plotChart = F,remove_prototypes = FALSE, get_perc = T)` %**
of pre-pandemic levels.
...
* The number of unique patients seen in the last 12 months is currently around
**`r plot_unique_patients_rolling_as_percent_of_feb_20(level = "Regional",region_STP_name = "North West", plotChart = F,remove_prototypes = FALSE, get_perc = T)` %**
of pre-pandemic levels.
...
* The number of unique patients seen in the last 12 months is currently around
**`r plot_unique_patients_rolling_as_percent_of_feb_20(level = "Regional",region_STP_name = "North East and Yorkshire", plotChart = F,remove_prototypes = FALSE, get_perc = T)` %**
of pre-pandemic levels.
...
* The number of unique patients seen in the last 12 months is currently around
**`r plot_unique_patients_rolling_as_percent_of_feb_20(level = "Regional",region_STP_name = "London", plotChart = F,remove_prototypes = FALSE, get_perc = T)` %**
of pre-pandemic levels.
...
* The number of unique patients seen in the last 12 months is currently around
**`r plot_unique_patients_rolling_as_percent_of_feb_20(level = "Regional",region_STP_name = "Midlands", plotChart = F,remove_prototypes = FALSE, get_perc = T)` %**
of pre-pandemic levels.
...
* The number of unique patients seen in the last 12 months is currently around
**`r plot_unique_patients_rolling_as_percent_of_feb_20(level = "Regional",region_STP_name = "East of England", plotChart = F,remove_prototypes = FALSE, get_perc = T)` %**
of pre-pandemic levels.
...
* Tables of DCP and Oral Health Assessment (BPE):
  + [NHSE_Sandbox_PrimaryCareNHSContracts].[Dental].[DCP]
  + [NHSE_Sandbox_PrimaryCareNHSContracts].[Dental].[BPE]
