...
```{r UDA_activity_Calendar_data, echo = FALSE, warning = FALSE, message = FALSE, fig.width=14, fig.height=5}
reactable(
...
data <- plot_UDA_UOA_delivery_calendar(data = UDA_calendar_data,
                                  scheduled_data = UDA_scheduled_data,
                                  contractor_cats = contractor_categories,
                                  UDAorUOA = "UDA",
                                  level = "National",
...
data <- plot_cumulative_UDA_UOA_to_target(data = UDA_calendar_data,
                                  UDAorUOA = "UDA",
                                  level = "National",
                                  region_STP_name = NULL,
                                  plotChart = F,
...
data <- plot_UDA_UOA_delivery_calendar(data = UOA_calendar_data,
                                  scheduled_data = UOA_scheduled_data,
                                  contractor_cats = contractor_categories,
                                  UDAorUOA = "UOA",
                                  level = "National",
...
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "South East")`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "South East")*100/get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "Regional", region_STP_name = "South East"))` %**
) have delivered the required UOAs or more to be on track towards the Q1 threshold (100%) by the end of June 2022.
...
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "South West")`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "South West")*100/get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "Regional", region_STP_name = "South West"))` %**
) have delivered the required UOAs or more to be on track towards the Q1 threshold (100%) by the end of June 2022.
...
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "North West")`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "North West")*100/get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "Regional", region_STP_name = "North West"))` %**
) have delivered the required UOAs or more to be on track towards the Q1 threshold (100%) by the end of June 2022.
...
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "North East and Yorkshire")`**
contracts (
...
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "London")`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "London")*100/get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "Regional", region_STP_name = "London"))` %**
) have delivered the required UOAs or more to be on track towards the Q1 threshold (100%) by the end of June 2022.
...
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "Midlands")`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "Midlands")*100/get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "Regional", region_STP_name = "Midlands"))` %**
) have delivered the required UOAs or more to be on track towards the Q1 threshold (100%) by the end of June 2022.
...
expected monthly total activity to achieve the quarterly thresholds (100% for Apr-Jun 22).
* From the start of April to the end of `r format(Sys.Date() - lubridate::weeks(4), "%B")`
**`r get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "East of England")`**
contracts (
**`r round(get_Q1_22_num_contracts_on_target(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, UDAorUOA = "UOA", level = "Regional", region_STP_name = "East of England")*100/get_num_contracts(UOA_calendar_data, remove_prototypes = T, UOA_scheduled_data, "UOA", level = "Regional", region_STP_name = "East of England"))` %**
) have delivered the required UOAs or more to be on track towards the Q1 threshold (100%) by the end of June 2022.
...
data <- plot_cumulative_UDA_UOA_to_target(data = UOA_calendar_data,
                                  UDAorUOA = "UOA",
                                  level = "National",
                                  region_STP_name = NULL,
                                  plotChart = F,
...
data %>%
  download_this(
    output_name = "UOA_delivery_scheduled_data",
    output_extension = ".xlsx",
    button_label = "Download data",
    button_type = "warning",
    has_icon = TRUE,
